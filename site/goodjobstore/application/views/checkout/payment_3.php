...
<input type="hidden" name="item_name" value="ORDER ID : <?php echo $order->Order_ID?>">
<input type="hidden" name="currency_code" value="THB">
<input type="hidden" name="amount" value="<?php echo $order->Final_Price?>">
<input type="hidden" name="return" value="http://online.goodjobstore.com/checkout/confirmation?order_id=<?php echo $order->Order_ID?>&status=complate">
...
<input type="hidden" name="invoice" value="<?php echo $order->Order_ID?>"> 
