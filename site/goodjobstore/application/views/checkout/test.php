<div>
	...
	<FORM METHOD="post" ACTION="https://www.krungsriepayment.net/EPayDefaultWeb/PaymentManager/PaymentInput.do"> 
		...
		<P>
			...
			ORDERNUMBER <INPUT TYPE="text" NAME="ORDERNUMBER" ID="ORDERNUMBER" SIZE="9" MAXLENGTH="9" value="<?php echo rand(000000001, 999999999)?>"><BR> 
			PAYMENTTYPE 
	        ...
	        LANGUAGE <INPUT size="20" type="text" name="LANGUAGE" value="<?php echo (LANG=='TH')?'TH':'EN';?>"> <BR> 
