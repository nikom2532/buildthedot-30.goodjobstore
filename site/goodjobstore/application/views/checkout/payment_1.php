...
<INPUT TYPE="hidden" NAME="ORDERNUMBER" ID="ORDERNUMBER" SIZE="9" MAXLENGTH="9" value="<?php echo rand(000000001, 999999999)?>"> 
<INPUT TYPE="hidden" NAME="PAYMENTTYPE" ID="PAYMENTTYPE" SIZE="9" MAXLENGTH="9" value="CreditCard" >
<INPUT TYPE="hidden" NAME="AMOUNT" ID="AMOUNT" SIZE="20" MAXLENGTH="20" value="<?php echo $order->Final_Price * 100?>">
...
<INPUT size="20" type="hidden" name="LANGUAGE" value="<?php echo (LANG=='TH')?'TH':'EN';?>">
<INPUT size="20" type="hidden" name="REF1" value="<?php echo $order->Order_ID?>">
<INPUT size="20" type="hidden" name="REF2">
<INPUT size="20" type="hidden" name="REF3"> 
<INPUT size="20" type="hidden" name="REF4"> 
<INPUT size="20" type="hidden" name="REF5" value="<?php echo $customer->Email?>">
