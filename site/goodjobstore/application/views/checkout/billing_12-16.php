				...
				<h4><?php echo (LANG=='TH')?'ที่อยู่ในการจัดส่งสินค้า':"Shipping Address";?></h4>
					<table id="address">
						<tbody>
							...
							<tr>
								<td style="text-align: right; padding-right: 20px;">
									<div id="s_city_prov_th" style="display:<?php echo (set_value('Country_ID', '')=='222')?'block':'none';?>;">
										<?php echo (LANG=='TH')?'จังหวัด':"Province";?>
									</div>
									<div id="s_city_prov_en" style="display:<?php echo (set_value('Country_ID', '')=='222')?'none':'block';?>;">
										<?php echo (LANG=='TH')?'เมือง':"City";?>
									</div>
								</td>
								<td><img src="<?php echo base_url()?>public/images/dot.gif" /></td>
						...
						<table>
							<tbody>
								...
								<tr class="tcl">
									...
									<td width="320px"><?php echo (LANG=='TH')?$value->Name_Th:$value->Name_En;?><br /><?php echo (LANG=='TH')?$value->Description_Th:$value->Description_En;?></td>
...
*/
									...
									<tr class="tcl">
										...
										<td width="320px"><?php echo $valueUPS->type_name?></td>
										<td width="80px">
											<?php
