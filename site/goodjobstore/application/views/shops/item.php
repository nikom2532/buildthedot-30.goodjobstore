		...
		<div id="product_content" class="clearfix">
							...
							<div class="content_slide">
								...
								{ ?>
									<a title="../../public/<?php echo $dataLevel["Path_Small"]?>"
										...
										viewHeadDetail('<?php echo $dataLevel['Product_ID']?>','','','<?php echo LANG?>');">
												<?php
												//------ Show shot msg title -----
			...
			<div id="product_head" class="clearfix">
					<div class="left">
						...
						<div id="head_detail">
							<script>viewHeadDetail('<?php echo $data['Product_ID']?>','','','<?php echo LANG?>');</script>
							<!-- view Head Detail -->
						</div>
					</div>  <!-- left -->
			...
			<script>
				...
				function filterColor(filter_Color,propType)
				{
					...
					viewHeadDetail(propType,filter_Color,'<?php echo $product_code?>','<?php echo LANG?>');
				...
				function filterProperty(filter_Property)
				{
					...
					viewHeadDetail(filter_Property,'','<?php echo $product_code?>','<?php echo LANG?>');
