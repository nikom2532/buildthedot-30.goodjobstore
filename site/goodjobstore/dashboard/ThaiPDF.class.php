...
function AddThaiFont($font="") {
	...
	if(!empty($font)) {
		if(array_key_exists($font, $thaifonts)) {
			...
			echo "<font size=\"+1\" color=red>��á�˹��͹��Դ��Ҵ</font><br />���Ϳ͹���·������ö��˹���:<br />";
	...
	for($j=0; $j<count($fontnames); $j++) {
		...
		if($fontnames[$j]!="tahoma") {						// Tahoma ����յ�����§
...
//Page No. settings
private $pn_align = "center";		//��èѴ�ҧ�����Ţ˹��
private $pn_prefix = "Page";	  	//�ӷ�������͹�����Ţ˹�� �� "˹��", "Page"
private $pn_sep = "/";				//����������ҧ�����Ţ˹�һѨ�غѹ�Ѻ�ӹǹ˹�ҷ����� �� 1/5
...
function Footer() {
	if(!$this->pn_show) {		//���������૵���������ʹ setPageNo() ����ͧ�ʴ������Ţ˹��
		return;					
	}
...
function writeHTML($html) {
	$pat = ">[[:space:]]{1,}<";							// <-- ��� Bug
	$html = eregi_replace($pat, "><", $html);		// <-- ��� Bug
...
function OpenTag($tag, $attr) {
    ...
    switch($tag) {
        ...
        case 'TD': // TD-BEGIN
            ...
            if(!empty($attr['ALIGN'])) {
                $align=strtoupper($attr['ALIGN']);   	// <-- ��� Bug
                if($align=='LEFT')  {
					$this->tdalign='L';
				}
                if($align=='CENTER')  {
