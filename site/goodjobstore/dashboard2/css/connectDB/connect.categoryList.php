	...
	<table>
		<tbody>
				...
				?>
					...
					<?php } ?>
							<td>
								<a href="../item/<?php echo $data['Product_ID']?>" style="text-decoration:none">
								...
								<!--****** Thai Language ******-->
						<!--	<div class="product_name"><?php echo $data['Pro_Name_Th']?></div>	-->
								...
								{ ?>
									<div class="price"><?php echo $data['Price_Buy']?> ฿</div>
								<?php } ?>
							</td>
					<?php if($i%4==3){ ?>
						</tr>
